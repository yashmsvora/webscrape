...
class CoinSpiderSelenium(scrapy.Spider):
    ...
    def __init__(self):
        ...
        rur_other = driver.find_elements_by_class_name("filterPanelItem___2z5Gb")
        rur_other[5].click()

        input_box = driver.find_element_by_xpath("//input[@class='searchText___3mLvd']")
        input_box.send_keys("rur")
